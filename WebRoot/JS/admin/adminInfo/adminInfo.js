$(document).ready(function(){
	...
	var submitInfo = {};
	generalAjaxCallToLoadData("acquireAdminInfo.action",submitInfo, showTeacherInfo);
});
...
function saveTeacherInfo() {
	...
	//异步调用
	generalAjaxCallToLoadData("saveAdminInfo.action",submitData, showSavingResult);
