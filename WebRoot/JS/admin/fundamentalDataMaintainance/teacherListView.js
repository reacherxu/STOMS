...
$(document).ready(function(){
	...
	generalAjaxCallToLoadData("acquireAllTeacherInfo.action",{},initializeTeacherTable);
});
...
function initializeTeacherTable(data){
	if(!data.actionStatus) {
		console.log("acquireAllTeacherInfo failed!");
		return false;
	}
...
function toEditPage(PK, isMdfy){
	...
	var detailInfoUrl = "Page/Admin/fundamentalDataMaintainance/teacherEdit.jsp?teacherPK=" + PK + "&isModifyPage=" + isMdfy;
