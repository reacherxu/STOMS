	...
	<script type="text/javascript">
		...
		window.onload = function () {
			...
			swfu5 = new SWFUpload({
				// Backend Settings
				upload_url: "<%=path%>/fileUpload.action",
				post_params: { "flag" : "NationalExl.xls"  },
				...
				upload_error_handler : uploadError,
				upload_success_handler : uploadSuccess,
				upload_complete_handler : uploadCompleteExpenditure,
				...
				button_width: 170,
				button_height: 18,
				button_text : '<span class="button">导入支出 Excel</span>',
				button_text_style : '.button { font-family: Helvetica, Arial, sans-serif; font-size: 12pt; }',
				button_text_top_padding: 0,
				button_text_left_padding: 18,
				button_window_mode: SWFUpload.WINDOW_MODE.TRANSPARENT,
	   	...
	   	<form id = "addMoneyForm" method="post">
			<table align="center" style="width: 80%;">
				<caption style = "height:40px;">
					<form>
						<tr>
					       <td width="140"> <div style="float:left;width: 170px; border: solid 1px #7FAAFF; background-color: #C5D9FF; padding: 2px;">
								<span id="spanButtonPlaceHolder"></span>
							</div></td>
							
							<td width="140"><div style="float:left;width: 140px; border: solid 1px #7FAAFF; background-color: #C5D9FF; padding: 2px;">
							...
							<td><div style="float:left;width: 140px; border: solid 1px #7FAAFF; background-color: #C5D9FF; padding: 2px;">
