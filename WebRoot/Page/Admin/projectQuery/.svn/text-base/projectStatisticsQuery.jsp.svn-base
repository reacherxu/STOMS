...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/admin/projectQuery/projectStatisticsQuery.js"></script>
  	...
  	<div align = "center">
  		<form method = "post" style = "width:95%;">
  			<table style = "width:100%;">
  				<caption style = "height:40px;"><h4>项目统计查询</h4></caption>
  			...
  			<jsp:include page="queryInputModule.jsp"/>
  				...
  				<tr>
	    			<td align = "center" colspan = "2">
	    				<button type="button" onclick = "projectStatisticsQuery()">查询</button>
		    		...
		    		<div id = "dt_example">
		    			<div align = "center">
		    				<div style = "width:95%" align = "left" id="container">
		    					<div class = "demo_jui">
		    					<table id = "projectStatisticsQueryTable" cellpadding="0" cellspacing="0" border="0" class="display">
								</table>
								</div>
							</div>
						</div>
