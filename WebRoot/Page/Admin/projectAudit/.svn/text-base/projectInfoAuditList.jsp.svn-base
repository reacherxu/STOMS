...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/admin/projectAudit/projectInfoAuditList.js"></script>
  ...
  <body id="dt_example">
  	...
  	<div align = "center">
	  	<div style = "width:95%" align = "left" id="container">
	  		...
	  		<div class = "demo_jui">
	  			<table id = "projectInfoAuditListTable" cellpadding="0" cellspacing="0" border="0" class="display">
	  			</table>
	  		</div>
	  	</div>
  	</div>
