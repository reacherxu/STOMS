...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/admin/projectAudit/A863AdjustAudit.js"></script>
	       ...
	       <table align="center" style = "width:90%;"  border="1" cellspacing="0"  borderColor="#7EC0EE">
			<caption style = "height:50px;"><h2>国家重大专项课题支出预算科目调整情况表</h2></caption>			
				...
				<tr>
					...
					<td><label id = "equipmentCost_adjust"></label></td>
					<td><label id = "equipmentCost_after"></label></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp; 2.材料费</td>
					<td><label id = "materialCost_before"></label></td>
					<td><label id = "materialCost_adjust"></label></td>
				...
				<tr>
					...
					<td><label id = "travelCost_adjust"></label></td>
				...
				<tr>
					...
					<td><label id = "exchangeCost_adjust"></label></td>
				...
				<div align = "center">
				<br/><br/>
				<button type = "button" id = "A863AdjustAuditPassButton">审批通过</button>
				<button type = "button" id = "A863AdjustAuditRejectButton">审批不通过</button>
				</div>
