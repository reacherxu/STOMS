...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/admin/projectAudit/budgetAdjustmentAuditList.js"></script>
  ...
  <body id="dt_example">
  	...
  	<div style = "width:95%" align = "center" id="container">
  		...
  		<div class = "demo_jui">
  			<table id = "budgetAdjustmentAuditListTable" cellpadding="0" cellspacing="0" border="0" class="display">
  			</table>
  		</div>
  	</div>
  </body>
