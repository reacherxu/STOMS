...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/admin/outlayStatisticsQuery/departmentLevelStatisticsQuery.js"></script>
  ...
  <body>
  	<div align = "center">
  		<form method = "post" style = "width:95%;">
  			...
  			<caption style = "height:30px;"><h4>按院系统计查询</h4></caption>
  				<tr>
					<td>项目类型
				...
				<tr>
	    			<td align = "center" colspan = "4">
	    				<button type="button" onclick = "departmentLevelStatisticsQuery()">查询</button>
  	...
  	<div id = "dt_example">
  		<div align = "center">
		  	<div style = "width:95%" align = "left" id="container">
		  		<div class = "demo_jui">
		  			<table id = "departmentLevelStatisticsListTable" cellpadding="0" cellspacing="0" border="0" class="display">
		  			</table>
		  		</div>
		  	</div>
  		</div>
