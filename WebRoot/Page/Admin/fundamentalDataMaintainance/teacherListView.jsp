...
<html>
	...
	<script type="text/javascript" src="JS/admin/fundamentalDataMaintainance/teacherListView.js"></script>
	...
	<body id="dt_example">
  	...
  	<div align = "center" id="container">
	  	<div style = "width:90%;" id = "demo">
	  			<table id = "teacherMaintainanceTable" cellpadding="0" cellspacing="0" border="0" class="display">
	  			</table>
	  	</div>
	  	<br/>
	  	<div>
	  		<button type="button" id = "addTeacherButton">增加</button>
	  		<button type="button" id = "deleteTeacherButton">删除</button>
	  		<button type="button" id = "modifyTeacherButton">修改</button>
	  	</div>
	 </div>
  </body>
</html>
