...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/admin/fundamentalDataMaintainance/adminEdit.js"></script>
			...
			<form id = "editTeacherForm" method = "post">
				<table>
					...
					<tr>
						...
						<td>
							<input type="text" class="validate[required, custom[number]]" id="mobile" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" class="validate[custom[email]]" id="email" />
						</td>
					</tr>
				</table>
				<br/>
