...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/admin/fundamentalDataMaintainance/projectTypeListView.js"></script>	
  </head>
  
  <body id="dt_example">
  	
  	<div align = "center" id="container">
	  	<div style = "width:95%;" id = "demo">
	  			<table id = "projectTypeMaintainanceTable" cellpadding="0" cellspacing="0" border="0" class="display">
	  			</table>
	  	</div>
	  	<br/>
	  	<div>
	  		<button type="button" id = "addProjectTypeButton">增加</button>
	  		<button type="button" id = "deleteProjectTypeButton">删除</button>
	  		<button type="button" id = "modifyProjectTypeButton">修改</button>
	  	</div>
	 </div>
  </body>
</html>
