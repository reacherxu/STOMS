...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/teacher/projectManagement/nationalFundAdjustList.js"></script>
 ...
 <body id="dt_example">
	...
	<table>
  	...
  	<div style = "width:95%" align = "center" id="container">
  		...
  		<div class = "demo_jui">
  			<table id = "nationalFundAdjustListTable" cellpadding="0" cellspacing="0" border="0" class="display">
  			</table>
  		</div>
  		<div>
  			<button type="button" id = "addNewNationalFundAdjustButton">新添调整</button>
  			<button type="button" id = "deleteNationalFundAdjustButton">删除</button>
  		</div>
