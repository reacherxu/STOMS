...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/teacher/outlayManagement/nationalFundOutlay.js"></script>
	...
	<div align="center"  >
		<table align="center" style = "width:90%;"  border="1" cellspacing="0"  borderColor="#7EC0EE">
			...
			<tr>
				...
				<td colspan="5"><label id = "approveID"></label></td>
			</tr>
			<tr>
				<td><label for = "dialFundsSum">已拨入经费(总额)</label></td>
				<td colspan="5"><label id = "dialFundsSum"></label></td>
			</tr>
			<tr bgColor=#e2e4ff>
				<td width="28%"><b>科目</b></td>
				<td width="15%"><b>预算经费</b></td>
				<td width="15%"><b>已支出经费</b></td>
				<td width="15%"><b>剩余经费</b></td>
				<td width="15%"><b>本次支出经费</b></td>
				<td width="12%"><b>说明</b></td>
			</tr>
			<tr bgColor=#F0FFF0>
				<td><b>一.研究经费</b></td>
				<td><label id = "studyFund_Budget"></label></td>
				<td><label id = "studyFund_AllOutlay"></label></td>
				<td><label id = "studyFund_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "sumBusiness_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "testCost_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "fuelCost_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "conferenceCost_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "publishCost_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "otherBusiness_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "sumMaterial_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "rawMaterial_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "otherMaterial_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "sumEquipment_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "buyEquipment_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "trialEquipment_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "laboratory_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "cooperation_Surplus"></label></td>
			...
			<tr bgColor=#F0FFF0>
				...
				<td><label id = "exchangeSum_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "exchange_Surplus"></label></td>
			...
			<tr>
				...
				<td><label id = "expert_Surplus"></label></td>
			...
			<tr bgColor=#F0FFF0 >
				...
				<td><label id = "serviceCost_Surplus"></label></td>
			...
			<tr bgColor=#F0FFF0>
				...
				<td><label id = "manageCost_Surplus"></label></td>
			...
			<tr bgColor=#e2e4ff>
				...
				<td><label id = "sums_Surplus"></label></td>
				<td><label id = "sums_Outlay"></label></td>
				<td><textarea id = "sums_Remark"></textarea></td>
			</tr>
			<tr>
				<td>已拨入经费结余</td>
				<td colspan="5"><label style = "width:100%;" id = "dialFundsLast"></label></td>
			</tr>
			<tr bgColor=#e2e4ff>
				<td><b>本项目其他经费来源</b></td>
				<td colspan="2">预算经费</td>
				<td colspan="3">经费支出</td>
			</tr>
			<tr>
				<td>国家其他计划资助经费</td>
				<td colspan="2"><label id = "otherPlanFundsBuget"></label></td>
				<td colspan="3"><input style = "width:60%" type="text" id = "otherPlanFundsOutlay" class="validate[custom[number]]" onchange = "otherItemFundSum()"/></td>
			</tr>
			<tr>
				<td>其他经费资助（含部门匹配）</td>
				<td colspan="2"><label id = "otherSubsidizeBuget"></label></td>
				<td colspan="3"><input style = "width:60%;" type="text" id = "otherSubsidizeOutlay" class="validate[custom[number]]" onchange = "otherItemFundSum()"/></td>
			</tr>
			<tr bgColor=#e2e4ff>
				<td><b>其他经费来源合计</b></td>
				<td colspan="2"><label style = "width:100%;" id = "otherSumBuget"></label></td>
				<td colspan="3"><label style = "width:60%;" id = "otherSumOutlay"></label></td>			
			</tr>	
		...
		<div align = "center">
			<br/><br/>
			<button type = "button" id = "nationalFundOutlaySubmitButton">提交</button>
