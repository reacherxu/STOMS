...
<html>
  <head>
	...
	<script type="text/javascript" src="JS/teacher/outlayManagement/provincialOutlayHistory.js"></script>
  ...
  <body id="dt_example">
	...
	<table>
		<tr>
			...
			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td >
			<a href="Page/Teacher/payRegistration/provincialOutlayStatistic.jsp?itemPK=<%= request.getParameter("itemPK")%>">*查看决算表*</a>
			</td>
		</tr>	
		</table>
		</div>
...
<div style = "width:95%" align = "center" id="container">
  		<div class = "demo_jui">
  			<table id = "provincialOutlayHistoryTable" cellpadding="0" cellspacing="0" border="0" class="display">
  			</table>
  		</div>
  		<div>
  		<button type="button" id = "addNewProvincialOutlayButton">新添支出</button>
  		<button type="button" id = "deleteProvincialOutlayButton">删除</button>
  	</div>
  	</div >
