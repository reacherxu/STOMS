...
/**
 * A863cooperationBudget entity. @author MyEclipse Persistence Tools
 */

public class A863cooperationBudget implements java.io.Serializable {

	// Fields

	private Long a863cooperationPk;
	private Long itemPk;
	...
	/** default constructor */
	public A863cooperationBudget() {
	}

	/** minimal constructor */
	public A863cooperationBudget(Long a863cooperationPk) {
		this.a863cooperationPk = a863cooperationPk;
	}

	/** full constructor */
	public A863cooperationBudget(Long a863cooperationPk, Long itemPk,
			String itemId, Integer cooperationId, String cooperationName,
			...
			Double indirectCost, Double subsidizeSpecial,
			Double otherFundsSelf, Double ownFundsSelf, Double otherSelf,
			Double selfFinance, Double fundSum, String astatus) {
		this.a863cooperationPk = a863cooperationPk;
		this.itemPk = itemPk;
		this.itemId = itemId;
	...
	public Long getA863cooperationPk() {
		return this.a863cooperationPk;
	}

	public void setA863cooperationPk(Long a863cooperationPk) {
		this.a863cooperationPk = a863cooperationPk;
	}
