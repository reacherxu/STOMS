...
/**
 * SelfFundOutlay entity. @author MyEclipse Persistence Tools
 */

public class SelfFundOutlay  implements java.io.Serializable {


    // Fields    

     private Long selfFundOutlayPk;
     private Long itemPk;
    ...
    /** default constructor */
    public SelfFundOutlay() {
    }

	/** minimal constructor */
    public SelfFundOutlay(Long selfFundOutlayPk) {
        this.selfFundOutlayPk = selfFundOutlayPk;
    }
    
    /** full constructor */
    public SelfFundOutlay(Long selfFundOutlayPk, Long itemPk, String itemId, Double staffCost, Double equipmentCost, Double fuelCost, Double materialCost, Double testCost, Double travelCost, Double conferenceCost, Double publishCost, Double manageCost, Double otherCost, Double sumCost, String outlayTime) {
        this.selfFundOutlayPk = selfFundOutlayPk;
        this.itemPk = itemPk;
        this.itemId = itemId;
    ...
    public Long getSelfFundOutlayPk() {
        return this.selfFundOutlayPk;
    }
    
    public void setSelfFundOutlayPk(Long selfFundOutlayPk) {
        this.selfFundOutlayPk = selfFundOutlayPk;
    }
