...
/**
 * NationalFundBudget entity. @author MyEclipse Persistence Tools
 */

public class NationalFundBudget implements java.io.Serializable {

	// Fields

	private Long nationalFundBudgetPk;
	private Long itemPk;
	...
	/** default constructor */
	public NationalFundBudget() {
	}

	/** minimal constructor */
	public NationalFundBudget(Long nationalFundBudgetPk) {
		this.nationalFundBudgetPk = nationalFundBudgetPk;
	}

	/** full constructor */
	public NationalFundBudget(Long nationalFundBudgetPk, Long itemPk,
			String itemId, Double testCost, Double fuelCost,
			Double conferenceCost, Double publishCost, Double otherBusiness,
			Double sumBusiness, Double rawMaterial, Double otherMaterial,
			Double sumMaterial, Double buyEquipment, Double trialEquipment,
			Double sumEquipment, Double laboratory, Double cooperation,
			Double studyFund, Double exchange, Double expert,
			Double exchangeSum, Double serviceCost, Double manageCost,
			Double sums, String nstatus) {
		this.nationalFundBudgetPk = nationalFundBudgetPk;
		this.itemPk = itemPk;
		this.itemId = itemId;
	...
	public Long getNationalFundBudgetPk() {
		return this.nationalFundBudgetPk;
	}

	public void setNationalFundBudgetPk(Long nationalFundBudgetPk) {
		this.nationalFundBudgetPk = nationalFundBudgetPk;
	}
