...
/**
 * SocialScienceNjubudget entity. @author MyEclipse Persistence Tools
 */

public class SocialScienceNjubudget implements java.io.Serializable {

	// Fields

	private Long socialScienceNjupk;
	private Long itemPk;
	...
	/** default constructor */
	public SocialScienceNjubudget() {
	}

	/** minimal constructor */
	public SocialScienceNjubudget(Long socialScienceNjupk) {
		this.socialScienceNjupk = socialScienceNjupk;
	}

	/** full constructor */
	public SocialScienceNjubudget(Long socialScienceNjupk, Long itemPk,
	...
	public Long getSocialScienceNjupk() {
		return this.socialScienceNjupk;
	}

	public void setSocialScienceNjupk(Long socialScienceNjupk) {
		this.socialScienceNjupk = socialScienceNjupk;
	}
