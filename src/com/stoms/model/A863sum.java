...
/**
 * A863sum entity. @author MyEclipse Persistence Tools
 */

public class A863sum  implements java.io.Serializable {


    // Fields    

     private Long a863sumPk;
     private Long itemPk;
	...
	/** minimal constructor */
    public A863sum(Long a863sumPk) {
        this.a863sumPk = a863sumPk;
    }
    
    /** full constructor */
    public A863sum(Long a863sumPk, Long itemPk, String itemId, Double buyEquipment, Double trialEquipment, Double transform, Double equipmentCost, Double materialCost, Double testCost, Double fuelCost, Double travelCost, Double conferenceCost, Double exchangeCost, Double publishCost, Double serviceCost, Double consultCost, Double constructionCost, Double otherCost, Double directCost, Double costSum, Double performanceCost, Double indirectCost, Double subsidizeSpecial, Double otherFundsSelf, Double ownFundsSelf, Double otherSelf, Double selfFinance, Double fundSum) {
        this.a863sumPk = a863sumPk;
        this.itemPk = itemPk;
        this.itemId = itemId;
    ...
    public Long getA863sumPk() {
        return this.a863sumPk;
    }
    
    public void setA863sumPk(Long a863sumPk) {
        this.a863sumPk = a863sumPk;
    }
