...
import com.stoms.utils.ExpenditureExcelExl;
...
public class FileUploadAction extends ActionSupport {
	...
	public String getBudgetToForm() {
		...
		try {
			AddOutlay addoutlay = pf.getData("d:/STOMS_FileData_temp/",
					"GuoJia.pdf");
			Department department = new Department();
			department = departmentService.acquireOneDepartmentInfoByName(addoutlay.getDepartmentName());
			addoutlay.setDepartmentId(department.getDepartmentId());
			actionStatus = true;
			String[] excludes = {};
			jsonResult = JSONTranslation.objectToJson(addoutlay, excludes);
	...
	public String uploadExcel() {
		jsonResult = "";
		try {
			ArrayList<ArrayList<String>> expenditure =
					(ArrayList<ArrayList<String>>) ExpenditureExcelExl.readExl("d:/STOMS_FileData_temp/NationalExl.xls");
			this.actionStatus = expenditureService.insert(expenditure);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			actionStatus = false;
