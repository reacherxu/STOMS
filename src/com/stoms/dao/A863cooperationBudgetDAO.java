 ...
 * A863cooperationBudget entities. Transaction control of the save(), update()
 * and delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.stoms.model.A863cooperationBudget
 * @author MyEclipse Persistence Tools
 */

public class A863cooperationBudgetDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(A863cooperationBudgetDAO.class);
	// property constants
	...
	public void save(A863cooperationBudget transientInstance) {
		log.debug("saving A863cooperationBudget instance");
		try {
	...
	public void delete(A863cooperationBudget persistentInstance) {
		log.debug("deleting A863cooperationBudget instance");
		try {
	...
	public A863cooperationBudget findById(java.lang.Long id) {
		log.debug("getting A863cooperationBudget instance with id: " + id);
		try {
			A863cooperationBudget instance = (A863cooperationBudget) getHibernateTemplate()
					.get("com.stoms.model.A863cooperationBudget", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(A863cooperationBudget instance) {
		log.debug("finding A863cooperationBudget instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding A863cooperationBudget instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from A863cooperationBudget as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all A863cooperationBudget instances");
		try {
			String queryString = "from A863cooperationBudget";
	...
	public A863cooperationBudget merge(A863cooperationBudget detachedInstance) {
		log.debug("merging A863cooperationBudget instance");
		try {
			A863cooperationBudget result = (A863cooperationBudget) getHibernateTemplate()
	...
	public void attachDirty(A863cooperationBudget instance) {
		log.debug("attaching dirty A863cooperationBudget instance");
		try {
	...
	public void attachClean(A863cooperationBudget instance) {
		log.debug("attaching clean A863cooperationBudget instance");
		try {
	...
	public static A863cooperationBudgetDAO getFromApplicationContext(
			ApplicationContext ctx) {
		return (A863cooperationBudgetDAO) ctx
				.getBean("A863cooperationBudgetDAO");
	}
}