...
/**
 	* A data access object (DAO) providing persistence and search support for SelfFundOutlay entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.stoms.model.SelfFundOutlay
  * @author MyEclipse Persistence Tools 
 */

public class SelfFundOutlayDAO extends HibernateDaoSupport  {
	     private static final Logger log = LoggerFactory.getLogger(SelfFundOutlayDAO.class);
		//property constants
    ...
    public void save(SelfFundOutlay transientInstance) {
        log.debug("saving SelfFundOutlay instance");
        try {
	...
	public void delete(SelfFundOutlay persistentInstance) {
        log.debug("deleting SelfFundOutlay instance");
        try {
    ...
    public SelfFundOutlay findById( java.lang.Long id) {
        log.debug("getting SelfFundOutlay instance with id: " + id);
        try {
            SelfFundOutlay instance = (SelfFundOutlay) getHibernateTemplate()
                    .get("com.stoms.model.SelfFundOutlay", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(SelfFundOutlay instance) {
        log.debug("finding SelfFundOutlay instance by example");
        try {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding SelfFundOutlay instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from SelfFundOutlay as model where model." 
         						+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all SelfFundOutlay instances");
		try {
			String queryString = "from SelfFundOutlay";
    ...
    public SelfFundOutlay merge(SelfFundOutlay detachedInstance) {
        log.debug("merging SelfFundOutlay instance");
        try {
            SelfFundOutlay result = (SelfFundOutlay) getHibernateTemplate()
    ...
    public void attachDirty(SelfFundOutlay instance) {
        log.debug("attaching dirty SelfFundOutlay instance");
        try {
    ...
    public void attachClean(SelfFundOutlay instance) {
        log.debug("attaching clean SelfFundOutlay instance");
        try {
	...
	public static SelfFundOutlayDAO getFromApplicationContext(ApplicationContext ctx) {
    	return (SelfFundOutlayDAO) ctx.getBean("SelfFundOutlayDAO");
	}
}