 ...
 * A863njubudget entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.stoms.model.A863njubudget
 * @author MyEclipse Persistence Tools
 */

public class A863njubudgetDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(A863njubudgetDAO.class);
	// property constants
	...
	public void save(A863njubudget transientInstance) {
		log.debug("saving A863njubudget instance");
		try {
	...
	public void delete(A863njubudget persistentInstance) {
		log.debug("deleting A863njubudget instance");
		try {
	...
	public A863njubudget findById(java.lang.Long id) {
		log.debug("getting A863njubudget instance with id: " + id);
		try {
			A863njubudget instance = (A863njubudget) getHibernateTemplate()
					.get("com.stoms.model.A863njubudget", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(A863njubudget instance) {
		log.debug("finding A863njubudget instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding A863njubudget instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from A863njubudget as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all A863njubudget instances");
		try {
			String queryString = "from A863njubudget";
	...
	public A863njubudget merge(A863njubudget detachedInstance) {
		log.debug("merging A863njubudget instance");
		try {
			A863njubudget result = (A863njubudget) getHibernateTemplate()
	...
	public void attachDirty(A863njubudget instance) {
		log.debug("attaching dirty A863njubudget instance");
		try {
	...
	public void attachClean(A863njubudget instance) {
		log.debug("attaching clean A863njubudget instance");
		try {
	...
	public static A863njubudgetDAO getFromApplicationContext(
			ApplicationContext ctx) {
		return (A863njubudgetDAO) ctx.getBean("A863njubudgetDAO");
	}
}