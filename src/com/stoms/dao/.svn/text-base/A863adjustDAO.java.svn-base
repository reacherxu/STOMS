...
/**
 	* A data access object (DAO) providing persistence and search support for A863adjust entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.stoms.model.A863adjust
  * @author MyEclipse Persistence Tools 
 */

public class A863adjustDAO extends HibernateDaoSupport  {
	     private static final Logger log = LoggerFactory.getLogger(A863adjustDAO.class);
		//property constants
    ...
    public void save(A863adjust transientInstance) {
        log.debug("saving A863adjust instance");
        try {
	...
	public void delete(A863adjust persistentInstance) {
        log.debug("deleting A863adjust instance");
        try {
    ...
    public A863adjust findById( java.lang.Long id) {
        log.debug("getting A863adjust instance with id: " + id);
        try {
            A863adjust instance = (A863adjust) getHibernateTemplate()
                    .get("com.stoms.model.A863adjust", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(A863adjust instance) {
        log.debug("finding A863adjust instance by example");
        try {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding A863adjust instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from A863adjust as model where model." 
         						+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all A863adjust instances");
		try {
			String queryString = "from A863adjust";
    ...
    public A863adjust merge(A863adjust detachedInstance) {
        log.debug("merging A863adjust instance");
        try {
            A863adjust result = (A863adjust) getHibernateTemplate()
    ...
    public void attachDirty(A863adjust instance) {
        log.debug("attaching dirty A863adjust instance");
        try {
    ...
    public void attachClean(A863adjust instance) {
        log.debug("attaching clean A863adjust instance");
        try {
	...
	public static A863adjustDAO getFromApplicationContext(ApplicationContext ctx) {
    	return (A863adjustDAO) ctx.getBean("A863adjustDAO");
	}
}