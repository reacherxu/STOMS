 ...
 * NationalFundRemark entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.stoms.model.NationalFundRemark
 * @author MyEclipse Persistence Tools
 */

public class NationalFundRemarkDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(NationalFundRemarkDAO.class);
	// property constants
	...
	public void save(NationalFundRemark transientInstance) {
		log.debug("saving NationalFundRemark instance");
		try {
	...
	public void delete(NationalFundRemark persistentInstance) {
		log.debug("deleting NationalFundRemark instance");
		try {
	...
	public NationalFundRemark findById(java.lang.Long id) {
		log.debug("getting NationalFundRemark instance with id: " + id);
		try {
			NationalFundRemark instance = (NationalFundRemark) getHibernateTemplate()
					.get("com.stoms.model.NationalFundRemark", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(NationalFundRemark instance) {
		log.debug("finding NationalFundRemark instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding NationalFundRemark instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from NationalFundRemark as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all NationalFundRemark instances");
		try {
			String queryString = "from NationalFundRemark";
	...
	public NationalFundRemark merge(NationalFundRemark detachedInstance) {
		log.debug("merging NationalFundRemark instance");
		try {
			NationalFundRemark result = (NationalFundRemark) getHibernateTemplate()
	...
	public void attachDirty(NationalFundRemark instance) {
		log.debug("attaching dirty NationalFundRemark instance");
		try {
	...
	public void attachClean(NationalFundRemark instance) {
		log.debug("attaching clean NationalFundRemark instance");
		try {
	...
	public static NationalFundRemarkDAO getFromApplicationContext(
			ApplicationContext ctx) {
		return (NationalFundRemarkDAO) ctx.getBean("NationalFundRemarkDAO");
	}
}