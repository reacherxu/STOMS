...
/**
 	* A data access object (DAO) providing persistence and search support for AgencyFundOutlay entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.stoms.model.AgencyFundOutlay
  * @author MyEclipse Persistence Tools 
 */

public class AgencyFundOutlayDAO extends HibernateDaoSupport  {
	     private static final Logger log = LoggerFactory.getLogger(AgencyFundOutlayDAO.class);
		//property constants
    ...
    public void save(AgencyFundOutlay transientInstance) {
        log.debug("saving AgencyFundOutlay instance");
        try {
	...
	public void delete(AgencyFundOutlay persistentInstance) {
        log.debug("deleting AgencyFundOutlay instance");
        try {
    ...
    public AgencyFundOutlay findById( java.lang.Long id) {
        log.debug("getting AgencyFundOutlay instance with id: " + id);
        try {
            AgencyFundOutlay instance = (AgencyFundOutlay) getHibernateTemplate()
                    .get("com.stoms.model.AgencyFundOutlay", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(AgencyFundOutlay instance) {
        log.debug("finding AgencyFundOutlay instance by example");
        try {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding AgencyFundOutlay instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from AgencyFundOutlay as model where model." 
         						+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all AgencyFundOutlay instances");
		try {
			String queryString = "from AgencyFundOutlay";
    ...
    public AgencyFundOutlay merge(AgencyFundOutlay detachedInstance) {
        log.debug("merging AgencyFundOutlay instance");
        try {
            AgencyFundOutlay result = (AgencyFundOutlay) getHibernateTemplate()
    ...
    public void attachDirty(AgencyFundOutlay instance) {
        log.debug("attaching dirty AgencyFundOutlay instance");
        try {
    ...
    public void attachClean(AgencyFundOutlay instance) {
        log.debug("attaching clean AgencyFundOutlay instance");
        try {
	...
	public static AgencyFundOutlayDAO getFromApplicationContext(ApplicationContext ctx) {
    	return (AgencyFundOutlayDAO) ctx.getBean("AgencyFundOutlayDAO");
	}
}